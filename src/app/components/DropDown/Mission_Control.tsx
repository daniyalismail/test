...
import Mission_Control_Icon from "@/app/icon/Mission_Control/Mission_Control_Icon";

export default function Mission_Control() {
        ...
        >
          ...
          >
            <div className="flex align-items-center gap-1">
              ...
              <span className="font-bold text-xs">MISSION CONTROL</span>
            </div>
